...
def get_inventory():
    ...
    with db.engine.begin() as connection:
        ...
        num_ml = connection.execute(sqlalchemy.text("SELECT num_green_ml FROM global_inventory")).one()[0]
        return {"number_of_potions": green_potions, "ml_in_barrels": num_ml, "gold": gold}
